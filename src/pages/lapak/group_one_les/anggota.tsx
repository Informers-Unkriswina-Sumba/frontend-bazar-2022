...
import { DATA_ANGGOTA_KELOMPOK } from 'constant/kelompok-1';
...
const Kelompok: NextPage = () => {
  return (
    <LayoutMainApp>
      <Head>
        <title>
          {APP_TITLE} | Lapak {LIST_LAPAK_DATA.KELOMPOK_1.namaLapak} | Anggota
        </title>
        <link rel='icon' href='/favicon.ico' />
      </Head>
      <Box px='15' mt='10' mb='20'>
        <Heading fontSize='25px' textAlign='center'>
          Anggota Lapak {LIST_LAPAK_DATA.KELOMPOK_1.namaLapak}
        </Heading>
